<script>
	...
	import { currentColorId } from './productCardStore.svelte.js';
...
<svg
	...
	style="enable-background:new 0 0 2000 2500;"
	xml:space="preserve"
>
	<style type="text/css">
		.st0 {
		...
		.st200 {
			...
			filter: drop-shadow(30px 24px 32px var(--shadow));
		}
	</style>
	<g id="Layer_2_00000017496323171280883470000017219769400578225042_">
		<g id="Layer_1-2">
			...
			<path
				...
				fill={color?.code}
				class="st1"
				d="M423.6,2317.5c-0.6,11,1.8,32,17.8,28.8c0,0,18.4,0.1,36.6,0.5c18.2,0.4,55.1-2.9,66.8-3.5
